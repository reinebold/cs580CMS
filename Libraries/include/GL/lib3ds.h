...
/**
    ...
    \param boundingBoxMin             Returned minimum x,y,z values.
    \param boundingBoxMax             Returned maximum x,y,z values.
 */
...
extern LIB3DSAPI void lib3ds_mesh_bounding_box(Lib3dsMesh *mesh, float boundingBoxMin[3], float boundingBoxMax[3]);
